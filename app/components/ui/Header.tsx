  ...
  return (
    <div className="w-full flex md:flex-row flex-col gap-5 justify-between p-4 bg-darkBlue">
      ...
      <div className="flex gap-2 md:justify-start justify-center">
        ...
        <div className="border-2 border-purple text-purple hover:text-darkText rounded-full px-4 py-2 font-medium flex items-center cursor-pointer hover:bg-purple ease-in-out duration-200 hover:scale-105 ">
          Eurojackpot
        </div>
      </div>
    </div>
